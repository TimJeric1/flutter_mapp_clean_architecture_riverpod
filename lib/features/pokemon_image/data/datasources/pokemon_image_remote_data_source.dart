...
part 'pokemon_image_remote_data_source.g.dart';

@riverpod
Future<PokemonImageRemoteDataSourceImpl> pokemonImageRemoteDataSourceImpl(PokemonImageRemoteDataSourceImplRef ref) async {
  final _dio = ref.read(dioProvider);
  return PokemonImageRemoteDataSourceImpl(dio: _dio);
}
